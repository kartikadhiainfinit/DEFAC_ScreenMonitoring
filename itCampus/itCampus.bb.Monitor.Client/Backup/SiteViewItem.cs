...
namespace itCampus.bb.Monitor.Client
{
	...
	public class SiteViewItem : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.panelPageAssigned.Controls.Add(this.labelCampaignName);
			...
			this.pictureBoxCoach.Location = new System.Drawing.Point(46, 14);
			...
			// labelCampaignName
			// 
			this.labelCampaignName.BackColor = System.Drawing.Color.Transparent;
			this.labelCampaignName.Location = new System.Drawing.Point(0, 48);
			this.labelCampaignName.Name = "labelCampaignName";
			this.labelCampaignName.Size = new System.Drawing.Size(62, 16);
			this.labelCampaignName.TabIndex = 3;
			this.labelCampaignName.Text = "Campaign";
			this.labelCampaignName.MouseUp += new System.Windows.Forms.MouseEventHandler(this.Control_MouseUp);
			this.labelCampaignName.MouseMove += new System.Windows.Forms.MouseEventHandler(this.Control_MouseMove);
			this.labelCampaignName.MouseDown += new System.Windows.Forms.MouseEventHandler(this.Control_MouseDown);
			// 
			// labelAgentCode
			// 
			...
			this.labelStateTime.Text = "00:00";
		...
		public void RefreshParameters()
		{
			...
			else
			{
				...
				RefreshLabel(labelCampaignName, _device.Frontend.CampaignName);
